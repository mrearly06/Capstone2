...
// Now safe to access session data
$userID = $_SESSION['userID'];

include "backend/connection.php";

// Fetch the user's details, including userType from the account table
$sql = "SELECT u.firstName, u.middleName, u.lastName, u.userImage, a.userType 
        FROM user u 
        JOIN account a ON u.userID = a.acc_id
       WHERE u.userID = ?";
...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link href="https://cdn.jsdelivr.net/npmbootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  .navbar {
    ...
    background-color: #0066ff !important; /* Slightly transparent green */
...
<nav class="navbar text-bg-primary border border-light mb-1">
  <div class="container-fluid d-flex justify-content-end">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end text-small" aria-labelledby="dropdownProfile">
