  ...
  <div class="container-fluid d-flex justify-content-end">
    ...
    <div class="dropdown profile-pic">
      ...
      <ul class="dropdown-menu dropdown-menu-end text-small" aria-labelledby="dropdownProfile">
        ...
        <li class="" id="logoutBtn"><a class="dropdown-item dropdown-item-logout" href="backend/logout.php">    <i class="fas fa-sign-out-alt me-2" style="background-color:	rgb(220,220,220); padding: 0.3rem; border-radius: 50%;"></i> Logout </a></li>
      </ul>
    </div>
  </div>
</nav>
